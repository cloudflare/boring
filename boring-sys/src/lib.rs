...
#[cfg(feature = "rpk")]
pub use generated::SSL_CREDENTIAL_new_raw_public_key;
...
#[cfg(feature = "mlkem")]
pub use generated::{MLKEM768_encap, MLKEM768_private_key_from_seed}; // your include path is incorrect or has a version of boringssl without mlkem support // RPK is native to BoringSSL at this version
